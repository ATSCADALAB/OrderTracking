...
//                    TotalPenalty = 0.0,
//                    RewardOrPenalty = 0.0,
//                    PenaltyDetails = "No data dữ liệu"
//                });
//            }
...
//                if (!events.Any())
//                {
//                    userResult.PenaltyDetails = "No data events trong khoảng thời gian này";
//                    continue;
//                }
...
//                else
//                {
//                    userResult.PenaltyDetails = "Có events nhưng No data orders hoàn thành";
//                }
//            }
...
//            // ✅ TẠO SHEET CHO TẤT CẢ USERS, KỂ CẢ NHỮNG USER No data EVENTS
//            foreach (var userCal in userCalendarDto)
//            {
...
//                {
//                    // ✅ USER No data CALENDAR HOẶC No data EVENTS - HIỂN THỊ 0
...
//                    sheet.Cell(9, 2).Value = "No data dữ liệu events trong khoảng thời gian này";
...
//                // Tính toán KPI (có thể là 0 nếu No data orders)
...
//            // Nếu No data phần TIMELINE rõ ràng, return toàn bộ content
//            return content.Trim();
//        }
            ...
            var excluded = new HashSet<string>(StringComparer.OrdinalIgnoreCase)
    {
        ...
        "Holidays in Vietnam", "soft@atpro.com.vn"
            ...
            foreach (var userCal in userCalendarDto)
            {
                ...
                sheet.Cell(7, 1).Value = "Total Overtime Days";
                sheet.Cell(7, 2).Value = overtimeDays;
                sheet.Cell(8, 1).Value = "List of Overtime Days";
                sheet.Cell(8, 2).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Right;
                sheet.Cell(8, 2).Value = overtimeDetails;
                sheet.Cell(9, 1).Value = "Bonus/Penalty";
                sheet.Cell(9, 2).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Right;
                sheet.Cell(9, 2).Value = Math.Round(reward, 0).ToString("#,##0");
                ...
                foreach (var o in orders)
                {
                    ...
                    sheet.Cell(row, 5).Value = o.EventDays + 1;
                    sheet.Cell(row, 6).Value = o.Stars;
                    sheet.Cell(row, 7).Value = o.PC;
                    row++;
                }

                // Format Excel
                sheet.Columns().AdjustToContents();
                var summaryRange = sheet.Range("A1:B9");
                summaryRange.Style.Fill.BackgroundColor = XLColor.LightGray;
                summaryRange.Style.Font.Bold = true;
                summaryRange.Style.Border.OutsideBorder = XLBorderStyleValues.Thin;
                summaryRange.Style.Border.InsideBorder = XLBorderStyleValues.Thin;
